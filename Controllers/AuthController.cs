...
public class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult> Login([FromBody] LoginDTO loginDto)
    {
        ...
        var client = _jwtDbContext.Clients.FirstOrDefault(c => c.ClientId == loginDto.ClientId);
        ...
        var user = await _jwtDbContext.Users
    ...
    private string GenerateJwtToken(User user, Client client)
    {
        ...
        var signingKey = _jwtDbContext.SigningKeys.FirstOrDefault(k => k.IsActive);
